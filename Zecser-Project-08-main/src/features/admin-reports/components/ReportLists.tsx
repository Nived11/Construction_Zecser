...
import {  FaClipboardList,  FaRegClock,  FaCheckCircle,  FaEdit,} from "react-icons/fa";
        ...
        <div className="flex items-center justify-between gap-2 w-full mb-10">
          ...
          <div className="w-32">
            <select
              ...
              className="w-full text-gray-600 text-sm text-center px-3 py-2 border  border-gray-300 rounded-lg focus:outline-none shadow-[0_1px_4px_-1px_rgba(0,0,0,0.4),0_-1px_4px_-1px_rgba(0,0,0,0.4)] focus:ring-1 focus:ring-primary cursor-pointer"
            >
      ...
      <div className="space-y-4">
        {loading
          ...
          : filteredReports.map((report) => (
              <div
                key={report.id}
                className="border rounded-lg p-4 shadow-[0_1px_4px_-1px_rgba(0,0,0,0.4),0_-1px_4px_-1px_rgba(0,0,0,0.4)] bg-white"
              >
                {/* Title */}
                ...
                <div className="grid grid-cols-2 gap-4 text-xs text-gray-600 mb-4 md:hidden">
                  <div className="col-span-2 flex justify-between items-center gap-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 text-[11px] text-gray-600 border rounded px-2 py-1 hover:bg-gray-100 shrink-0 mt-[-25px]
                      shadow-[0_1px_4px_-1px_rgba(0,0,0,0.4),0_-1px_4px_-1px_rgba(0,0,0,0.4)]" >
                  ...
                  <div>
                    <span className="font-semibold block text-[11px] mb-2 ">
                      Status
                    </span>
                    <span
                ...
                <div className="hidden md:grid grid-cols-5 gap-3 text-sm text-gray-600 mb-4">
                  ...
                  <p>
                    ...
                    <button
                      onClick={() => setEditingReport(report)}
                      className="flex items-center gap-1 text-sm text-gray-600 border rounded px-2 py-1 hover:bg-gray-100 hover:text-primary 
                shadow-[0_1px_4px_-1px_rgba(0,0,0,0.4),0_-1px_4px_-1px_rgba(0,0,0,0.4)]"
                    >
